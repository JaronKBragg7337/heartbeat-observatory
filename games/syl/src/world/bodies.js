...
const BASE_BODIES = [
  {
    ...
    landingZones: [
      ...
      {
        id: 'fortis_salvage_yard',
        name: 'Fortis Salvage Yard',
        dir: [0.04802, 0.99812, -0.03814],
        angularRadius: 0.028,
        flatten: true,
        factionId: 'fortis',
        structures: 'depot',
        discovery: { resourceItemId: 'fuel_hydrazine', note: 'A Fortis reserve cache left for stranded pilots.' },
      },
      {
        id: 'fortis_civil_terminal',
        name: 'Fortis Civil Terminal — Earth Line',
        dir: [0.16, 0.982, 0.09],
        angularRadius: 0.034,
        flatten: true,
        factionId: 'fortis',
        structures: 'transit',
        discovery: { resourceItemId: 'wiring_loom', note: 'Public transit crews keep spare avionics here for line maintenance.' },
      },
    ],
  ...
  },
  {
    ...
    landingZones: [
      ...
      {
        id: 'tranquility_transit_hub',
        name: 'Tranquility Civil Hub',
        dir: [-0.32, 0.73, 0.61],
        angularRadius: 0.07,
        flatten: true,
        factionId: 'meridian',
        structures: 'transit',
        discovery: { resourceItemId: 'ore_regolith', note: 'Meridian keeps a public shuttle dock beside the survey field.' },
      },
    ],
    spawn: null,
  ...
  },
  {
    ...
    landingZones: [
      ...
      {
        id: 'freeport_transit_dock',
        name: 'Freeport Transit Dock',
        dir: [0.68, 0.61, -0.22],
        angularRadius: 0.1,
        flatten: true,
        factionId: 'freeport',
        structures: 'transit',
        discovery: { resourceItemId: 'fuel_hydrazine', note: 'Freeport sells spare seats and spare propellant from the same dock.' },
      },
    ],
    spawn: null,
