...
function buildInterior(kind) {
  ...
  if (kind === "theater") {
    ...
    // State language: idle screen says what it is waiting for; if a reel can't load it says so and
    // moves on; if nothing loads the screen stays clearly unavailable.
