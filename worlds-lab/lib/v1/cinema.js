// WORLDS LAB · lib v1 · cinema.js — walk-in movie theaters that play REAL film.
...
import { marqueeTexture, posterTexture, textTexture, curtainTexture, carpetTexture, brickTexture } from "./textures.js";
import { buildRoomShell } from "./buildings.js";
...
export const FILMS = {
  blender: [
    { title: "Big Buck Bunny", year: 2008, license: "CC BY 3.0", credit: "(c) 2008 Blender Foundation | bigbuckbunny.org", hue: 95, src: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4" },
    { title: "Sintel", year: 2010, license: "CC BY 3.0", credit: "(c) 2010 Blender Foundation | sintel.org", hue: 18, src: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4" },
    { title: "Tears of Steel", year: 2012, license: "CC BY 3.0", credit: "(c) 2012 Blender Foundation | tearsofsteel.org", hue: 205, src: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4" },
    { title: "Elephants Dream", year: 2006, license: "CC BY 2.5", credit: "(c) 2006 Blender Foundation / NMAI | orange.blender.org", hue: 268, src: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4" },
  ],
  classics: [
